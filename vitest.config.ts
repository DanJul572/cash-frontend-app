    ...
    resolve: {
        alias: {
            ...
            'react-hook-form': path.resolve(
                __dirname,
                'src/__mocks__/react-hook-form.ts',
            ),
            '@hookform/resolvers/zod': path.resolve(
                __dirname,
                'src/__mocks__/@hookform/resolvers/zod.ts',
            ),
            '@mui/material/Alert': path.resolve(
                __dirname,
                'src/__mocks__/@mui/material/Alert.tsx',
            ),
            '@mui/material/Box': path.resolve(
                __dirname,
                'src/__mocks__/@mui/material/Box.tsx',
            ),
            '@mui/material/Button': path.resolve(
                __dirname,
                'src/__mocks__/@mui/material/Button.tsx',
            ),
            '@mui/material/Card': path.resolve(
                __dirname,
                'src/__mocks__/@mui/material/Card.tsx',
            ),
