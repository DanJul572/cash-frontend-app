...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@hookform/resolvers/zod': path.resolve(dirname, 'src/__mocks__/@hookform/resolvers/zod.ts'),
      ...
      '@mui/material/TextField': path.resolve(dirname, 'src/__mocks__/@mui/material/TextField.tsx'),
    },
  },
});
